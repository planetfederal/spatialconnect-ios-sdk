...
- (void)testYield {
  ...
  XCTAssertEqual(myCoroutine(), 1,
                 @"expected second coroutine call to yield 1");
  XCTAssertEqual(myCoroutine(), 2, @"expected third coroutine call to yield 2");
  XCTAssertEqual(myCoroutine(), 0,
                 @"expected restarted coroutine call to yield 0");
  XCTAssertEqual(myCoroutine(), 1,
                 @"expected second coroutine call to yield 1");
  ...
  XCTAssertEqual(myCoroutine(), 18,
                 @"expected second coroutine call to yield 18");
  XCTAssertEqual(myCoroutine(), 5,
                 @"expected restarted coroutine call to yield 5");
}
