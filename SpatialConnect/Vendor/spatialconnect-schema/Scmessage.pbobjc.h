...
@interface ScmessageRoot : GPBRootObject
@end

#pragma mark - SCMessage

typedef GPB_ENUM(SCMessage_FieldNumber) {
  SCMessage_FieldNumber_CorrelationId = 1,
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *replyTo;
